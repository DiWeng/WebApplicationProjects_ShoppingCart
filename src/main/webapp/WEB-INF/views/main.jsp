...
<html lang="zh-CN">
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">Type 1 <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">Type 2</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">Type 3</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">Type 4</a></li>
					<li class="list-group-item-diy"><a href="#productArea5">Type 5</a></li>
					<li class="list-group-item-diy"><a href="#productArea6">Type 6</a></li>
					<li class="list-group-item-diy"><a href="#productArea7">Type 7</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
  ...
  <script type="text/javascript">
      ...
      productType[3] = "Type 3";
      productType[4] = "Type 4";
      productType[5] = "Type 5";
      productType[6] = "Type 6";
      productType[7] = "Type 7";
