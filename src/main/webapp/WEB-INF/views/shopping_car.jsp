  ...
  <body>
	...
	<script type="text/javascript">
		...
		function addToShoppingRecordsPre(productsId,productsCounts) {
			...
			layer.confirm('Go to Order？', {icon: 1, title:'Purchased Successfully',btn:['Go to Order','Continue Shopping']},
					function(){
		...
		function addToShoppingRecords(productId,productCounts) {
			...
			if(buyResult == "success") {
				...
				layer.msg("Product "+product.name+" Purchased Successfully",{icon:1});
			}
			else if(buyResult == "unEnough"){
				layer.alert("Product "+product.name+" Product Not Enough")
			}
		}
