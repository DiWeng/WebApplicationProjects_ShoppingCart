        ...
        <div class="col-sm-10  col-md-10 col-sm-offset-1 col-md-offset-1">
            <div class="row">
                <ul class="nav nav-tabs list-group-diy" role="tablist">
                    <li role="presentation" class="active list-group-item-diy"><a href="#unHandle" aria-controls="unHandle" role="tab" data-toggle="tab">Wait for shipment&nbsp;<span class="badge" id="unHandleCount">0</span></a></li>
...
<script type="text/javascript">
    ...
    function updateShoppingRecords() {
        ...
        orderArray[0] = "Order has shipped";
        orderArray[1] = "In delivery";
        orderArray[2] = "Arrvied";
