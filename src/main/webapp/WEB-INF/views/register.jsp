        ...
        <div class="col-sm-offset-2 col-md-offest-2">
            ...
            <div  class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <input type="text" class="form-control" id="postcodes" placeholder="zip code" />
                    </div>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript">
        function startRegister() {
            ...
            if(user.userName == ''){
                ...
                layer.msg('username cannot exceed 12',{icon:2});
                return;
            }
            if(user.nickName == ''){
                ...
                layer.msg('nick name cannot exceed 15',{icon:2});
                return;
            }
                ...
                layer.msg('password cannot exceed 20',{icon:2});
                return;
            }
            ...
            if(registerResult == 'success'){
                layer.close(loading);
                layer.msg('register successfully',{icon:1});
                window.location.href="${cp}/login";
            }
            else if(registerResult == 'nameExist'){
                layer.close(loading);
                layer.msg('already taken！',{icon:2});
            }
            else if(registerResult == 'emailExist'){
                layer.close(loading);
                layer.msg('aready taken！',{icon:2});
            }
